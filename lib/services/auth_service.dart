...
class AuthService{
  ...
  Future registerEmailPass({required String email, required String password, required String name})async{
  ...
  Future signInEmailAndPass({required String email, required String password})async{
